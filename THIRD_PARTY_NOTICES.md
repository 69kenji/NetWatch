...
NetWatch ships mpv as a separate executable and controls it through JSON IPC. See [`resources/mpv/README.md`](resources/mpv/README.md) for exact hashes and corresponding-source requirements.
